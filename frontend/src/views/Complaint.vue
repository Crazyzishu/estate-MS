...
<template>
  <div class="houses-container">
    ...
    <div class="page-header">
      <h1 class="title">投诉管理</h1>
      <p class="description">管理和维护所有投诉信息</p>
    </div>
        ...
        <el-row :gutter="20">
          <el-col :span="7">
            <el-form-item label="投诉编号">
              <el-input v-model="searchHouse.addressKeyword" placeholder="请输入编号" />
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="投诉状态">
              <el-input-number v-model="searchHouse.minPrice" :controls="false" placeholder="请输入姓名" />
            </el-form-item>
          </el-col>
          <el-col :span="7">
...
<!--          </el-col>-->
    ...
    <el-card>
      ...
      <el-table :data="houseList" border style="width: 100%" :row-key="getRowKey">
        ...
        <el-table-column prop="houseId" label="投诉编号" width="60" />

        <el-table-column prop="address" label="客户姓名" width="150" />

        <el-table-column prop="address" label="客户信息" width="300" />

        <el-table-column prop="price" label="投诉楼盘" width="170">
          <template #default="scope">
            ¥{{ formatNumber(scope.row.price) }}
          </template>
        </el-table-column>
        <el-table-column prop="roomType" label="提交时间" width="250" />
